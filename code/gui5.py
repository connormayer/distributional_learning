...
def run_clusterer():
    do_clustering_tk = Clusterer_tk(
        file_name_ent.get(), output_file_ent.get(), v_scalar_ent.get(), 
        constrain_partition_var.get(), constrain_pcs_var.get()
    )
